...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../edt_zc702.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../edt_zc702.gen/sources_1/bd/system/ipshared/ee60/hdl" \
       +incdir+"../../../../edt_zc702.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../edt_zc702.gen/sources_1/bd/system/ipshared/ee60/hdl" \
